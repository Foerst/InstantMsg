...
@interface ChatCell ()<JCAudioPlayerDelegate>
{
    UILabel *_timeLb;
    UIButton *_textBtn;
    UIButton *_avatorBtn;
...
//    }
    if ([cellFrame.cellMsg.body hasPrefix:@"http"] || [cellFrame.cellMsg.body hasPrefix:@"file:///"]) {//链接
        ...
        if (0 == ft) {//图片
            ...
            if (cellFrame.cellMsg.isOutgoing) {
    ...
    [_avatorBtn setBackgroundImage:[UIImage imageWithData:cellFrame.cellMsg.imgData] forState:UIControlStateNormal];
